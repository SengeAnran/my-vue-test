...
<div class="right">
  ...
  <div class="btns">
    ...
    <el-button @click="modelVisible = true"  type="primary">模板管理</el-button>
  </div>
  <div class="content">
    {{detailInfo.content}}
  </div>
